// <copyright file="KafkaHelperTopicCreator.cs" company="McLaren Applied Ltd.">
//
...
namespace MA.DataPlatforms.Secu4.RouteSubscriberComponent.IntegrationTest.Kafka.Helper;

internal class KafkaHelperTopicCreator
{
    private readonly IAdminClient adminClient;

    public KafkaHelperTopicCreator(string server)
    {
