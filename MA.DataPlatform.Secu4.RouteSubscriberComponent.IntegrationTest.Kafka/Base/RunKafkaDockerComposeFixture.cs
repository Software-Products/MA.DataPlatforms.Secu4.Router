// <copyright file="RunKafkaDockerComposeFixture.cs" company="Motion Applied Ltd.">
//
...
namespace MA.DataPlatforms.Secu4.RouteSubscriberComponent.IntegrationTest.Kafka.Base;
...
public class RunKafkaDockerComposeFixture : IAsyncLifetime
{
    public async Task DisposeAsync()
    {
        ...
        ShellCommandExecutor.Execute("docker-compose", $"-p subscription down");
    ...
    public async Task InitializeAsync()
    {
        ...
        ShellCommandExecutor.RunDockerCompose($"{testDirectory}\\docker-compose.yml", "subscription");
        await WaitForContainerToStart("route_subscription_integration_test_kafka_server");
