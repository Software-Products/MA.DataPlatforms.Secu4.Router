// <copyright file="KafkaRouteSubscriberShould.cs" company="Motion Applied Ltd.">
//
...
public class KafkaRouteSubscriberShould
{
    ...
    public void Raise_Event_On_Listener_MessageReceived_Event()
    {
        ...
        listener.When(i => i.StartListening(kafkaRoute)).Do(_ => listener.MessageReceived += Raise.Event<EventHandler<RoutingDataPacket>>(
            this,
