...
using MA.DataPlatform.Secu4.RouteReaderComponent.IntegrationTest.Kafka.Base;
...
namespace MA.DataPlatform.Secu4.RouteReaderComponent.IntegrationTest.Kafka.Tests;
