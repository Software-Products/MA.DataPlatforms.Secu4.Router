...
public class RunKafkaDockerComposeFixture : IAsyncLifetime
{
    public async Task DisposeAsync()
    {
        ...
        ShellCommandExecutor.Execute("docker-compose", $"-p reader down");
    ...
    public async Task InitializeAsync()
    {
        ...
        ShellCommandExecutor.RunDockerCompose($"{testDirectory}\\docker-compose.yml", "reader");
        await WaitForContainerToStart("route_reader_integration_test_kafka_server");
