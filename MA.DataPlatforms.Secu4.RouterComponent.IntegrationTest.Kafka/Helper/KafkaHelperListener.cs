// <copyright file="KafkaHelperListener.cs" company="McLaren Applied Ltd.">
//
...
internal class KafkaHelperListener<TKey, TData>
{
    private readonly string topic;
    private readonly CancellationToken cancellationToken;
    private readonly IConsumer<TKey, TData> consumer;

    public KafkaHelperListener(string server, string topic, CancellationToken cancellationToken)
    {
        this.topic = topic;
