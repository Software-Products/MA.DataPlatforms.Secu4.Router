...
public class RunKafkaDockerComposeFixture : IAsyncLifetime
{
    public async Task DisposeAsync()
    {
        ...
        ShellCommandExecutor.Execute("docker-compose", $"-p routing down");
    ...
    public async Task InitializeAsync()
    {
        ...
        ShellCommandExecutor.RunDockerCompose($"{testDirectory}\\docker-compose.yml", "routing");
        await WaitForContainerToStart("router_integration_test_kafka_server");
